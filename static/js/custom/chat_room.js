...
// Event delegation: Attach a single event listener to the chat container
const chatBox = document.getElementById('chat-messages');
chatBox.addEventListener('contextmenu', function (event) {
    const messageElement = event.target.closest('.d-flex'); // Adjust this selector based on your HTML structure
