"""
Django settings for gantt_project project.
...
INSTALLED_APPS = [
    ...
    'gantt_app',  # Your app for handling tasks and projects
    'channels',
...
ASGI_APPLICATION = 'gantt_project.asgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'gantt_app.context_processors.unread_notifications_count',
                'gantt_app.context_processors.unread_notifications_context',
                'gantt_app.context_processors.notifications_context',
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'gantt_app.User'
