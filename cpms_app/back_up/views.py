...
def task_create(request, project_id):
    ...
    if request.method == 'POST':
        ...
        ActivityLog.objects.create(
            ...
            created_object_data=json.loads(task.to_json())
        )
...
def task_edit(request, project_id, task_id):
    ...
    if request.method == 'POST':
        ...
        # Handle assigned users if changed
...
def task_delete(request, project_id, task_id):
    ...
    if request.method == 'POST':
        # Capture task details just before deletion
        deleted_task_data = {
            "name": task.name,
            "start_date": task.start_date,
            "end_date": task.end_date,
        ...
        # Log the task deletion activity with deleted object data
        ActivityLog.objects.create(
            user=request.user,
            ...
            object_id=task.id,
            timestamp=timezone.now(),
            deleted_object_data=deleted_task_data  # Store the task data to deleted_object_data field
        )
