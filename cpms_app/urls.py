...
urlpatterns = [
    ...
    path("projects/milestones/<int:milestone_id>/edit/", views.milestone_edit, name="milestone_edit"),
    path("projects/<int:project_id>/milestones/<int:milestone_id>/delete/", views.milestone_delete, name="milestone_delete"),
    ...
    path("milestone/<int:milestone_id>/task/create/", views.task_create, name="create_task"),
    ...
    path('api/steps/<int:task_id>/', views.StepsByTask.as_view(), name='steps_by_task'),
    path("step/<int:step_id>/<int:x>/edit/", views.edit_task_step, name="edit_task_step"),

    path('tasks/<int:task_id>/steps/', views.manage_task_steps, name='manage_task_steps'),
    path('bulk-actions/<int:task_id>/', views.bulk_step_actions, name='bulk_step_actions'),
    path('steps/<int:step_id>/issues/', views.handle_issues, name='handle_issues'),

    path("milestone/<int:project_id>/milestones/<int:milestone_id>/updates/", views.milestone_updates, name="milestone_updates"),
    path('milestone/<int:milestone_id>/update_status/', views.milestone_status_update, name='milestone_status_update'),
